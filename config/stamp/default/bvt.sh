...
LMS_URL=edxtest2-learning.$BASE_URL
CMS_URL=edxtest2-studio.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/edxtest2/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/edxtest2/edx-platform.git
